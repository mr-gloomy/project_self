...
<script type="text/javascript">
	function commentOpen(rev_num) {
		...
		window.open("./reviewComment.jsp?rev_num=" + rev_num, "", 'width='
	...
	function view(x, y, z) {
		...
		newin.document
				.write("<html><head><title>:: Image View</title></head><body background='"
						+ x
						+ "' onclick='self.close()' style='cursor:hand' title='CLOSED'></body></html>");
	}
</script>
				...
				<div class="bd-example bd-example-tabs">
					...
					<div class="tab-content" id="pills-tabContent">
						...
						<div class="tab-pane fade" id="pills-review" role="tabpanel"
							...
							<div class="row">
								<div class="col-md-7">
									<h3 class="head">${requestScope.cnt}개의리뷰</h3>
										...
										<c:choose>
											<c:when test="${dto.rev_lev == 2 }">
												<div class="review d-flex">
													...
													<div class="desc">
														<h4>
															<span class="text-left">${dto.mem_nickName }</span> <span
											...
											<c:when test="${dto.rev_lev == 0 }">
												<div class="review d-flex">
													<div class="user-img"
														style="background-image: url(./upload/${dto.rev_image.split(',')[0] })"
														OnClick="view('./upload/${dto.rev_image.split(',')[0] }','','width=500,height=400,left=0,top=0');return false"></div>
													<div class="desc">
														<h4>
															<span class="text-left">
																<h5>${dto.mem_nickName }</h5> <br>
																${dto.rev_subject }
															</span> <span class="text-right">${dto.rev_date }</span>
														</h4>
														<p class="star">
															...
															</span> <span class="text-right"> <a
																href="javascript:commentOpen(${dto.rev_num });"
																class="reply"> <i class="icon-reply"></i>
															</a>
															</span>
														</p>
														<p>${dto.rev_content }</p>
										...
										<div class="rating-wrap">
											...
											<div class="wrap">
												<p class="star">
													...
													</span> <span>${star5} 개의 리뷰</span>
												</p>
												<p class="star">
													<span> <i class="ion-ios-star"></i> <i
														class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
														class="ion-ios-star"></i>
													</span> <span>${star4 } 개의 리뷰</span>
												</p>
												<p class="star">
													<span> <i class="ion-ios-star"></i> <i
														class="ion-ios-star"></i> <i class="ion-ios-star"></i>
													</span> <span>${star3 } 개의 리뷰</span>
												</p>
												<p class="star">
													<span> <i class="ion-ios-star"></i> <i
														class="ion-ios-star"></i>
													</span> <span>${star2 } 개의 리뷰</span>
												</p>
												<p class="star">
													<span> <i class="ion-ios-star"></i>
													</span> <span>${star1 } 개의 리뷰</span>
												</p>
											</div>
										</div>
									</div>
